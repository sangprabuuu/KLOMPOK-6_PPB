            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5),
                  Text(
                    'GOODETHICS - Celana Bahan Formal Pria Slimfit',
                    style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                    ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5),
                            Text(
                                'Keren sih ini dengan harga sgtu kualitas nya bagus dan gk ada miss nya...saya senang berbelanja di toko anda, semoga semakin jaya dan di tingkaktkan terus pelayanan dan kualitas nya jngan smpe kendor...smoga berkah'),
                          ],
                        ),
                      ),
                    ],
                  ...
                  _buildReview(
                    'pu3pratiwi',
                    'Bahan dan cuttingnya bagus sekali, suami aku suka. Nyaman dan tebal bahannya, warna hitam pekat. Bisa dipake kerja atau acara formal. Next harus beli lagi warna yang lain. Karna suami udah jatuh cinta sama model dan cuttingnya. Goodethics emang the best. Pertahankan kualitas yah',
                    'assets/profile.png',
                  ),
                  SizedBox(height: 15),
                  Divider(thickness: 5),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5),
                  Text(
                    'Menyediakan fasilitas tukar size Tersedia size 27 hingga 38 (size lokal). Bahan jatoh, potongan slimfit. Jadi selalu terlihat mewah. Cocok untuk segala aktivitas pria. Bahan: semi wool',
                    style: TextStyle(
                      fontSize: 14,
                      height: 1.5,
                    ),
