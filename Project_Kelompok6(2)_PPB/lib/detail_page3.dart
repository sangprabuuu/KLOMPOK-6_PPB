            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5),
                  Text(
                    'LABUBU ORIGINAL NEW BLIND BOX SEGEL',
                    style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                    ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5),
                            Text(
                                'Sempet ga dipickup kurir, terus janjian sama seller karena anakku yg pengen cepet dapet labubu..seller fast respon thank youu seller'),
                          ],
                        ),
                      ),
                    ],
                  ...
                  _buildReview(
                    'yaqx6cduaq',
                    'Pengiriman dari toko cepat. Cuman lama di pengiriman ekpedisi 6 hari baru sampai mungkin Kebarengan sama promo 11.11.barang 100%original popmart sudah di scan barcode nya masuk popmart asli. Barang aman. Toko amanah. Harga murah. Bisa buat langganan. Thank you.',
                    'assets/profile.png',
                  ),
                  SizedBox(height: 15),
                  Divider(thickness: 5),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5),
                  Text(
                    'Mainan koleksi seru buat penggemar Labubu, dijamin 100% asli! Scan barcode untuk cek keaslian di website resmi Popmart. Blind box tersedia atau pilih gaya (cek ke layanan pelanggan). Blind box masih tersegel, untuk pilihan gaya, kotak dibuka hanya untuk cek warna kartu, foiled tetap segel. Mohon konfirmasi pada admin mengenai kondisi unselaed box. Banyak produk palsu beredar! Kami menjamin barang ini original 100%.',
                    style: TextStyle(
                      fontSize: 14,
                      height: 1.5,
                    ),
