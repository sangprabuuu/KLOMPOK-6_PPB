...
import 'package:tubes_ppb/detail_page1.dart';
...
class ProductPage5 extends StatelessWidget {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5),
                            Text(
                                'Barang datang dengan kondisi baik, tanpa kerusakan dan berfungsi dengan baik. Seller sangat ramah dan care banget, ditanyai satu2 apakah ada kerusakan atau tidak, recommended bgt order disini.. thx seller, semoga makin lancar usahanya'),
                          ],
                        ),
                      ),
                    ],
                  ...
                  _buildReview(
                    'h*****6',
                    'Produk seperti benar2x Ori... setelah dicek Model dan Serial Number nya, memang barang yg diproduksi dan terdaftar tuk diluar negeri, tidak terdaftar di Indonesia, atau bukan garansi resmi Indonesia. Bisa terbaca oleh Galaxy Wearable dan barang yang dikirim masih segel dan rapih. Pokoknya mantul',
                    'assets/profile.png',
                  ),
                  SizedBox(height: 15),
                  Divider(thickness: 5),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5),
                  Text(
                    'Galaxy Buds Live memang memiliki wujud yang sangat berbeda dari earbuds lainnya. la tidak memiliki pucuk untuk menyantolkan buds ke dalam lubang telinga. Permukaannya sangat rata dan fungsinya hanya untuk menutupi permukaan lubang telinga saja. Desain tersebut ternyata yang memungkinka Buds Live memiliki fitur ANC. Earbuds kacan seperti earbuds dengan Passive Noise Canc Bentuknya agak mirip seperti kac mengandalkan ujung buds untuk menyamar lingkungan sekitar.',
                    style: TextStyle(
                      fontSize: 14,
                      height: 1.5,
                    ),
