...
class ProductPage6 extends StatelessWidget {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5),
                            Text(
                                'Paket sudah sampai barang sangat bagus sangat berekspektasi pokoknya is the best. sukss sllu buat shopee mall dan insurgent'),
                          ],
                        ),
                      ),
                    ],
                  ...
                  _buildReview(
                    'm*****m',
                    'Bahan kain tebal, bordir tulisan b aja, ga bagus2 banget ga jelek jg. Bagian dalem Alus, yg luar agak kasar. Uk XL di tb 180 bb 72 oversized dikit bagus lah',
                    'assets/profile.png',
                  ),
                  SizedBox(height: 15),
                  Divider(thickness: 5),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5),
                  Text(
                    'Kain Heavyweight Katun mempunyai karak unik dan khas. Walaupun mempunyai tekstur yang kasar, kain ini memiliki daya serap yang sangat baik dan juga menjadi salah satu kain dengan ketahanan kain yang sangat tinggi. Maka itu, kain akan lebih kuat dan tidak mudah rusak. Yang membedakan selain texture kasar adalah kain ini memiliki berat gramasi 330 gsm (gram square per mater) Dengan memiliki ketebalan tersebut membuat bahan ini memiliki masa pakai lebih lama, warna dari Heavyweight Cotton ini tidak mudah pudar. Meskipun di cuci berkali - kali, Heavyweight 100% Cotton ini tidak akan cepat pudar atau luntur, dengan tetap memerhatikan beberapa aspek misalnya cara pencuciannya, dan yang pasti mengikuti cara aturan pencucian.',
                    style: TextStyle(
                      fontSize: 14,
                      height: 1.5,
                    ),
